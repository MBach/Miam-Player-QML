...
QHash<int, QByteArray> LibraryItemModel::roleNames() const
{
    ...
    roles[Miam::DF_ID] = "id";
    roles[Miam::DF_URI] = "uri";
    roles[Miam::DF_CoverPath] = "coverPath";
    roles[Miam::DF_TrackNumber] = "trackNumber";
    roles[Miam::DF_DiscNumber] = "discNumber";
    roles[Miam::DF_NormalizedString] = "normalizedString";
    roles[Miam::DF_Year] = "year";
    roles[Miam::DF_Highlighted] = "highlighted";
    roles[Miam::DF_IsRemote] = "isRemote";
    roles[Miam::DF_IconPath] = "iconPath";
    roles[Miam::DF_Rating] = "rating";
    roles[Miam::DF_CustomDisplayText] = "customDisplayText";
    roles[Miam::DF_NormArtist] = "normArtist";
    roles[Miam::DF_NormAlbum] = "normAlbum";
    roles[Miam::DF_TrackLength] = "trackLength";
    roles[Miam::DF_CurrentPosition] = "currentPosition";
    roles[Miam::DF_Artist] = "artist";
    roles[Miam::DF_Album] = "album";
    roles[Miam::DF_InternalCover] = "internalCover";
    return roles;
}
